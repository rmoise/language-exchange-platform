...
export default function SearchFilters() {
  ...
  const [nativeFilter, setNativeFilter] = useState(searchParams.get('native') || '')
  const [targetFilter, setTargetFilter] = useState(searchParams.get('target') || '')
  const [locationFilter, setLocationFilter] = useState(searchParams.get('location') || '')
  const [enableLocationFilter, setEnableLocationFilter] = useState(searchParams.get('useLocation') === 'true')
  ...
  const handleSearch = () => {
    ...
    router.push(`/protected/search?${params.toString()}`)
  }
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      <Box sx={{ 
        ...
        <Typography sx={{ fontSize: '0.75rem', fontWeight: 500, color: 'white', mb: 2 }}>
          Location Filters
        </Typography>
        ...
        {enableLocationFilter && (
          <Box>
            <Typography sx={{ fontSize: '0.75rem', color: 'rgba(255, 255, 255, 0.8)', mb: 1 }}>
